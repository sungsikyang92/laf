...
public class FileUtils {
    ...
    public List<PictureDto> parseFileInfo(String boardNo, MultipartHttpServletRequest multipartHttpServletRequest)
            throws Exception {
        ...
        // 저장되는 Path 설정입니다. 각자의 경로가 다르기에 시스템상으로 Path.of....을 사용하여 경로를 구하고 마지막 저장될 파일 경로를
        // 따로 기입해줍니다.
        String rootPath = "";
