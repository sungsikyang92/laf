...
//        String rootPath = "src/main/resources/static/img/communityBoard/";
        ...
        if (boardNo.contains("com")) {
            rootPath = Path.of(resourceLoader.getResource("classpath:static/img").getURI()).toString() + "/communityBoard/";
        } else if (boardNo.contains("l")) {
            rootPath = Path.of(resourceLoader.getResource("classpath:static/img").getURI()).toString() + "/lostBoard/";
        } else if (boardNo.contains("mp")) {
            rootPath = Path.of(resourceLoader.getResource("classpath:static/img").getURI()).toString() + "/myPageProfile/";
        }
